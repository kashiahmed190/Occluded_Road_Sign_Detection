...
import evaluate_detection as ed   # reuses YoloDetector, FrcnnDetector, model registry, etc.
...
def main():
    ...
    print(f"  Synthesized {len(level0_samples)} clean (0%) baseline samples")
